...
async function analyze(){
  ...
  for(const g of todo){
    ...
    const pr='You are an NFL handicapper using Billy Walters\' method. Power ratings already contain player values; injuries are deltas net of the backup; stars measure disagreement with the market and are NOT edge by themselves.\n'+
      ...
      'Standard to apply: over 2015-2025 this model went 51.1% against the spread on games it flagged, below the 52.4% needed to break even, and its disagreements have not predicted results. A gap is therefore NOT a reason to bet on its own. Recommend a bet ONLY when a specific piece of information sits behind the gap that the market may not have priced -- an injury, an availability change, a QB change. If both rosters are listed at full strength and the gap comes from the power ratings, the answer is NO BET no matter how large the gap. Early-season ratings are the least reliable of the year.\n'+
