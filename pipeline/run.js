...
async function analyze(){
  ...
  for(const g of todo){
    ...
    const pr='You are an NFL handicapper using Billy Walters\' method. Power ratings already contain player values; injuries are deltas net of the backup; stars measure disagreement with the market and are NOT edge by themselves.\n'+
      ...
      'Standard to apply, measured over 2015-2025: every flagged game went 51.1% against the spread, under the 52.4% needed to break even, so a gap is not a reason to bet on its own. Injury news behind a gap does NOT improve it (51.1% with news, 54.7% without) because the market prices injuries quickly; the injuries are already in our number. The only slice that held up was two stars or more on a game the market prices at three points or more, which returned 52.6% in held-out seasons. Recommend TAKE only if the gap looks like a genuine mispricing rather than our ratings drifting, and say NO BET whenever the case rests on the size of the gap alone. Early-season ratings are the least reliable of the year.\n'+
      'Task: explain in 4-6 sentences what is driving the disagreement, whether it is information or rating drift, and give a recommendation of TAKE HOME / TAKE AWAY / NO BET with confidence 1-5.\n'+
